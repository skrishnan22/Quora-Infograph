...
upv_ques=document.getElementsByClassName("PagedList UserAnswerProfileFeed")[0].getElementsByClassName("QuestionText")[upv_pos].innerText;
upv_h=human_format(total_upv);
views = document.getElementsByClassName("PagedList UserAnswerProfileFeed")[0].getElementsByClassName("ContentFooter AnswerFooter");	
view_max=0;
for(j=0;j<views.length;j++)
{   c = convert(views[j].getElementsByClassName("meta_num")[0].innerHTML)
	total_views+=c;
	if(c>view_max)
	{
		view_max=c;
...
view_ques=document.getElementsByClassName("PagedList UserAnswerProfileFeed")[0].getElementsByClassName("QuestionText")[view_pos].innerText;
